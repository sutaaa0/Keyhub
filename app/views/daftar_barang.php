<?php 
    ...
    if($searchTerm) {
        $result = $barang->search($searchTerm);
    } else {
...
<body>
    <div class="flex items-center justify-center w-full h-screen relative">
        ...
        <div class="flex flex-col">
            <div class="py-4">
                <h1 class="font-bold text-4xl">Daftar Barang</h1>
            </div>
            <div class="flex space-x-3 mb-3">
                ...
                <a href="tambah_barang.php"><button class="btn">Tambah Barang</button></a>
            </div>
            <div class="table-container">
                <table class="table">
                    ...
                    <tr class="sticky top-0 bg-white">
                        <th class="px-4"></th>
                        <th class="text-base">Nama barang</th>
                        <th class="text-base">Harga</th>
                    ...
                    <?php foreach ( $result as $data ) : ?>
                        <tr class="h-16">
                            ...
                            <td>
                                ...
                                <a href="edit_barang.php?id=<?= $data["id_barang"] ?>">
